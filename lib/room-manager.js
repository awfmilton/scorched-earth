...
class RoomManager {
  ...
  /* STUBS FOR FUTURE CHUNKS (Disconnect handling) */
  ...
  fire(connectionId, payload) {
    ...
    /*
     * Preserve this rationale in a comment: Math.sin/Math.cos/Math.pow are not bit-identical across JS engines, but + - * / are.
