/**
 * JOIN_ROOM { code }, SET_PROFILE { name, colour }, FIRE { angle, power, weapon }, RESOLVE_SHOT { shotId }, REJOIN { code, playerToken }, SHOP_DONE { inventory }, ELIMINATED { turnNumber, slots }.
...
const optionalFields = {
  ...
  [C2S.SHOP_DONE]: new Set(['inventory']),
 ...
 * @param {*} val
 * @returns {Object|null} a fresh plain object, or null if there is nothing usable
 */
