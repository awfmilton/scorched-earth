...
> Last updated: 2026-08-22T18:06:17.938Z
...
- Cloud Run downstream MCP servers: none registered
- Vault credentials: 6 available — discover IDs at runtime with `list_vault_credentials` (values are never shown; reference as `kodex://vault/<id>`)
