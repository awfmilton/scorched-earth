...
function runTests() {
  ...
  console.log("Γ£ô SCORCHED global exposed successfully.");
  ...
  console.log("Γ£ô Headless game instance created successfully.");
  ...
  console.log("Γ£ô Headless game start config stored and parsed correctly.");
  ...
  console.log("Γ£ô Tank roster properties, spacing, and jitter verified successfully.");
  ...
  setTimeout(() => {
    ...
    console.log("Γ£ô Initial 4 player slots rendered correctly on load.");
    ...
    console.log("Γ£ô Dynamically updated player slots to 2 successfully.");
    ...
    console.log("Γ£ô Duplicate color rejection successfully prevented game start.");
    ...
    console.log("Γ£ô Setup modal is correctly hidden on successful start.");
    ...
    console.log(`Γ£ô Bullet shot from ${startX.toFixed(2)} landed at ${impactX.toFixed(2)} in zero wind.`);
    ...
    console.log(`Γ£ô Bullet with negative wind (-50) landed at ${windImpactX.toFixed(2)}.`);
    ...
    console.log(`Γ£ô 'off' wall mode result: impactX = ${offResult.wallImpactX}`);
    ...
    console.log(`Γ£ô 'rubber' wall mode result: bounced = ${rubberResult.bounced}, impactX = ${rubberResult.wallImpactX}`);
    ...
    console.log(`Γ£ô 'wrap' wall mode result: wrapped = ${wrapResult.wrapped}, impactX = ${wrapResult.wallImpactX}`);
    if (!wrapResult.wrapped) {
      throw new Error("Bullet did not wrap around screen under 'wrap' wall mode!");
    }

    const concreteResult = runWallTest('concrete');
    console.log(`Γ£ô 'concrete' wall mode result: bounced = ${concreteResult.bounced}, impactX = ${concreteResult.wallImpactX}`);
    ...
    console.log("Γ£ô Testing turn rotation skipping dead tanks...");
    ...
    console.log("Γ£ô Correctly skipped dead P2.");
    ...
    console.log("Γ£ô Handed turn back to P1.");

    // Test 3.5: AI Autoshot and complete fire-to-impact cycle completely driven by stepPhysics
    console.log("Γ£ô Testing AI autoshot driven purely by stepPhysics...");
    ...
    console.log(`Γ£ô AI player 1 fired projectile with angle ${aiGame.roster[0].angle} and power ${aiGame.roster[0].power}.`);
    ...
    console.log(`Γ£ô AI player 2 fired projectile with angle ${aiGame.roster[1].angle} and power ${aiGame.roster[1].power}.`);
    ...
    console.log(`Γ£ô Direct hit reduced HP from ${initialTargetHp} to ${postImpactTargetHp}. Heights array changed.`);
    ...
    console.log(`Γ£ô Tank fell into carved crater, taking drop damage. HP reduced to ${fallDamageHp}.`);
    ...
    console.log("Γ£ô Parachute successfully consumed, preventing drop damage entirely.");
    ...
    console.log(`Γ£ô Pre-allocated particle pool verified. Spawning 700 particles capped active count at ${activeParticlesCount}.`);
    ...
    console.log("Γ£ô Target killed during flight. Firing tank credited with kill. Turn advanced to remaining alive player.");
    ...
    console.log("Γ£ô Blast damage absorbed by shield before hp.");

    // Test 6.2: REGRESSION ΓÇö napalm burn must also be absorbed by the shield.
    ...
    console.log("Γ£ô Napalm burn absorbed by shield and credited to damageDealt.");
    ...
    console.log("Γ£ô Napalm burn damages an unshielded tank.");
    ...
    console.log("Γ£ô Auto Defense re-raises a shield collapsed by napalm burn.");
    ...
    console.log("Γ£ô Ammo decrements on fire; zero ammo blocks firing; Baby Missile unlimited.");
    ...
    console.log("Γ£ô MIRV splits into 5 sub-projectiles at apex.");
    ...
    console.log("Γ£ô Nameless projectile handled without throwing.");
    ...
    console.log("Γ£ô Round-end payouts, stat reset, and cumulative stat accumulation verified successfully.");
    ...
    console.log("Γ£ô buy(tank, id) functionality and validation checks verified successfully.");
    ...
    console.log("Γ£ô basic-only config option filters non-basic weapons successfully.");

    console.log("\nALL TESTS PASSED SUCCESSFULLY! ≡ƒÄë");
  }, 50);
}
